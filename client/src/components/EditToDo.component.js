...
export default class EditToDo  extends Component {
   ...
   onSubmit(e){               // fire on submit form
      e.preventDefault();
      ...
      axios.post('http://localhost:4000/todos/update/'+this.props.match.params.id, newTodo)       // to bring our state datas to the url
            ...
            <form onSubmit={this.onSubmit}>
               ...
               <div className="form-group">
                  ...
                  <div className="form-check">
                     <input className="form-check-input" type="checkbox" name="completedCheckbox" id="completedCheckbox" value={this.state.todo_completed} checked={this.state.todo_completed} onChange={this.onChangeTodoCompleted} />
